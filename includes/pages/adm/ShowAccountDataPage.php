	...
	if (!empty($id_u))
	{
		...
		else
		{
			...
			$template->assign_vars(array(
				...
				'ac_register_ally_time'			=> $LNG['ac_register_ally_time'],
				'ac_ali_logo_11'				=> $LNG['ac_ali_logo_11'],
				'ac_ali_text_11'				=> $LNG['ac_ali_text_11'],
				'ac_ali_text_22'				=> $LNG['ac_ali_text_22'],
				'ac_ali_text_33'				=> $LNG['ac_ali_text_33'],
				'ac_recent_destroyed_planets'	=> $LNG['ac_recent_destroyed_planets'],
				'ac_isnodestruyed'				=> $LNG['ac_isnodestruyed'],
