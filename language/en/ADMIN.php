...
// Player activity
$LNG['modul_43'] = 'Player activity';
$LNG['telemetry_setting_analysis_events'] = 'Events analysed per account or exchange';
$LNG['telemetry_setting_analysis_events_help'] = '';
$LNG['telemetry_setting_analysis_accounts'] = 'Accounts or exchanges analysed per pass';
$LNG['telemetry_setting_analysis_accounts_help'] = '';
$LNG['telemetry_setting_cleanup_rows'] = 'Rows deleted per cleanup pass';
$LNG['telemetry_setting_cleanup_rows_help'] = '';
$LNG['telemetry_setting_reserve_mb'] = 'Space to keep free';
$LNG['telemetry_setting_reserve_mb_help'] = 'Stops detailed collection; in the shared database, stops all collection.';
$LNG['telemetry_setting_budget_mb'] = 'Database size limit';
$LNG['telemetry_setting_budget_mb_help'] = 'Includes tables and indexes.';
$LNG['telemetry_setting_closed_days'] = 'Keep dismissed warnings';
$LNG['telemetry_setting_closed_days_help'] = 'Open warnings are retained.';
$LNG['telemetry_setting_daily_days'] = 'Keep activity windows';
$LNG['telemetry_setting_daily_days_help'] = '';
$LNG['telemetry_setting_event_days'] = 'Keep detailed actions';
$LNG['telemetry_setting_event_days_help'] = 'Must cover automation analysis. Deliveries are kept longer to include repayments.';
$LNG['telemetry_setting_moon_context_hours'] = 'Time between delivery and combat';
$LNG['telemetry_setting_moon_context_hours_help'] = 'Nearby combat may indicate a moon attempt.';
$LNG['telemetry_setting_push_points_fraction'] = 'Threshold relative to the recipient’s points';
$LNG['telemetry_setting_push_points_fraction_help'] = 'Percentage of points converted to resources. The higher threshold applies.';
$LNG['telemetry_setting_push_minimum'] = 'Minimum benefit to flag';
$LNG['telemetry_setting_push_minimum_help'] = 'After repayments and the allowed imbalance.';
$LNG['telemetry_setting_imbalance_allowance'] = 'Allowed imbalance';
$LNG['telemetry_setting_imbalance_allowance_help'] = 'Share of sent resources allowed without repayment.';
$LNG['telemetry_setting_rate_crystal_max'] = 'Maximum crystal rate';
$LNG['telemetry_setting_rate_crystal_max_help'] = '';
$LNG['telemetry_setting_rate_crystal_min'] = 'Minimum crystal rate';
$LNG['telemetry_setting_rate_crystal_min_help'] = '';
$LNG['telemetry_setting_rate_metal_max'] = 'Maximum metal rate';
$LNG['telemetry_setting_rate_metal_max_help'] = '';
$LNG['telemetry_setting_rate_metal_min'] = 'Minimum metal rate';
$LNG['telemetry_setting_rate_metal_min_help'] = '';
$LNG['telemetry_setting_repayment_hours'] = 'Repayment deadline';
$LNG['telemetry_setting_repayment_hours_help'] = '';
$LNG['telemetry_setting_push_days'] = 'Analysis period';
$LNG['telemetry_setting_push_days_help'] = '';
$LNG['telemetry_setting_traversal_min'] = 'Consecutive systems visited';
$LNG['telemetry_setting_traversal_min_help'] = '';
$LNG['telemetry_setting_poll_span_hours'] = 'Minimum viewing span';
$LNG['telemetry_setting_poll_span_hours_help'] = '';
$LNG['telemetry_setting_poll_min'] = 'Minimum galaxy views';
$LNG['telemetry_setting_poll_min_help'] = '';
$LNG['telemetry_setting_workflow_share'] = 'Minimum share of actions in the sequence';
$LNG['telemetry_setting_workflow_share_help'] = '';
$LNG['telemetry_setting_workflow_min'] = 'Minimum sequence repetitions';
$LNG['telemetry_setting_workflow_min_help'] = '';
$LNG['telemetry_setting_timing_share'] = 'Minimum share of regular intervals';
$LNG['telemetry_setting_timing_share_help'] = '';
$LNG['telemetry_setting_timing_tolerance'] = 'Allowed interval variation';
$LNG['telemetry_setting_timing_tolerance_help'] = '';
$LNG['telemetry_setting_timing_min'] = 'Actions before timing analysis';
$LNG['telemetry_setting_timing_min_help'] = '';
$LNG['telemetry_setting_automation_days'] = 'Analysis period';
$LNG['telemetry_setting_automation_days_help'] = '';
$LNG['telemetry_setting_activity_gap_hours'] = 'Maximum break considered short';
$LNG['telemetry_setting_activity_gap_hours_help'] = '';
$LNG['telemetry_setting_activity_min_days'] = 'Days required for a moderate signal';
$LNG['telemetry_setting_activity_min_days_help'] = '';
$LNG['telemetry_setting_activity_hours'] = 'Minimum active time per day';
$LNG['telemetry_setting_activity_hours_help'] = '';
$LNG['telemetry_setting_activity_days'] = 'Analysis period';
$LNG['telemetry_setting_activity_days_help'] = 'Complete UTC days.';
$LNG['telemetry_setting_network_enabled'] = 'Record IP addresses and client profiles';
$LNG['telemetry_setting_network_enabled_help'] = 'Browser, operating system and device type.';
$LNG['telemetry_setting_events_enabled'] = 'Record detailed actions';
$LNG['telemetry_setting_events_enabled_help'] = '';
$LNG['telemetry_label_enabled'] = 'Collection';
$LNG['telemetry_label_availability'] = 'Activity span';
$LNG['telemetry_label_timing'] = 'Regular timing';
$LNG['telemetry_label_workflow'] = 'Repeated sequence';
$LNG['telemetry_label_polling'] = 'Repeated views';
$LNG['telemetry_label_traversal'] = 'System traversal';
$LNG['telemetry_label_weak'] = 'Weak';
$LNG['telemetry_label_moderate'] = 'Moderate';
$LNG['telemetry_label_uncertain'] = 'Uncertain';
$LNG['telemetry_label_pending'] = 'Awaiting repayment';
$LNG['telemetry_label_open'] = 'To review';
$LNG['telemetry_label_follow_up'] = 'Follow up';
$LNG['telemetry_label_dismissed'] = 'Dismissed';
$LNG['telemetry_label_interaction'] = 'Navigation';
$LNG['telemetry_label_client'] = 'Reported client';
$LNG['telemetry_label_login'] = 'Login';
$LNG['telemetry_label_fleet_send'] = 'Fleet send';
$LNG['telemetry_label_fleet_recall'] = 'Fleet recall';
$LNG['telemetry_label_queue_buildings'] = 'Construction';
$LNG['telemetry_label_queue_research'] = 'Research';
$LNG['telemetry_label_queue_shipyard'] = 'Shipyard';
$LNG['telemetry_label_account_officer'] = 'Recruitment';
$LNG['telemetry_label_account_settings'] = 'Account settings';
$LNG['telemetry_label_galaxy_view'] = 'Galaxy view';
$LNG['telemetry_label_delivery'] = 'Delivery';
$LNG['telemetry_label_combat'] = 'Combat';
$LNG['telemetry_label_days'] = 'Days';
$LNG['telemetry_label_day'] = 'Day (UTC)';
$LNG['telemetry_label_active_seconds'] = 'Estimated active time';
$LNG['telemetry_label_windows'] = 'Activity windows';
$LNG['telemetry_label_largest_gap_seconds'] = 'Longest gap';
$LNG['telemetry_label_short_gap_days'] = 'Days with short gaps';
$LNG['telemetry_label_required_days'] = 'Required days';
$LNG['telemetry_label_share'] = 'Share';
$LNG['telemetry_label_period'] = 'Intervals per pattern';
$LNG['telemetry_label_seconds'] = 'Durations';
$LNG['telemetry_label_observations'] = 'Observations';
$LNG['telemetry_label_repeats'] = 'Repetitions';
$LNG['telemetry_label_pattern'] = 'Sequence';
$LNG['telemetry_label_starts'] = 'Repetition starts';
$LNG['telemetry_label_checks'] = 'Views';
$LNG['telemetry_label_span_seconds'] = 'Observation span';
$LNG['telemetry_label_consecutive_systems'] = 'Consecutive systems';
$LNG['telemetry_label_sender'] = 'Sender';
$LNG['telemetry_label_recipient'] = 'Recipient';
$LNG['telemetry_label_sent'] = 'Resources sent';
$LNG['telemetry_label_overdue_sent'] = 'Overdue sends';
$LNG['telemetry_label_returned'] = 'Resources received in return';
$LNG['telemetry_label_balance'] = 'Overdue balance';
$LNG['telemetry_label_total_balance'] = 'Total balance';
$LNG['telemetry_label_remaining'] = 'Benefit after allowance (deuterium equivalent)';
$LNG['telemetry_label_sent_value'] = 'Value sent';
$LNG['telemetry_label_returned_value'] = 'Value returned';
$LNG['telemetry_label_rate'] = 'Selected M:C:D rate';
$LNG['telemetry_label_minimum'] = 'Minimum benefit';
$LNG['telemetry_label_awaiting_repayment'] = 'Awaiting repayment';
$LNG['telemetry_label_deadline'] = 'Deadline';
$LNG['telemetry_label_allowed_rates'] = 'Allowed M:C:D rates';
$LNG['telemetry_label_allowance'] = 'Allowance';
$LNG['telemetry_label_metal'] = 'Metal';
$LNG['telemetry_label_crystal'] = 'Crystal';
$LNG['telemetry_label_deuterium'] = 'Deuterium';
$LNG['telemetry_label_planet'] = 'Planet';
$LNG['telemetry_label_galaxy'] = 'Galaxy';
$LNG['telemetry_label_system'] = 'System';
$LNG['telemetry_label_mission'] = 'Mission';
$LNG['telemetry_label_command'] = 'Command';
$LNG['telemetry_label_moon_chance'] = 'Moon chance (%)';
$LNG['telemetry_label_building'] = 'Building';
$LNG['telemetry_label_research'] = 'Research';
$LNG['telemetry_label_before'] = 'Before';
$LNG['telemetry_label_after'] = 'After';
$LNG['telemetry_label_note'] = 'Note';
$LNG['telemetry_label_ip'] = 'Source address';
$LNG['telemetry_label_write_failed'] = 'Write failed';
$LNG['telemetry_label_buffer_failed'] = 'Buffer failed';
$LNG['telemetry_label_request_limit'] = 'Request event limit';
$LNG['telemetry_label_disabled'] = 'Collection disabled';
$LNG['telemetry_label_events_disabled'] = 'Detailed history disabled';
$LNG['telemetry_label_storage_events'] = 'Storage: events suspended';
$LNG['telemetry_label_retention'] = 'History removed by retention';
$LNG['telemetry_label_health_unavailable'] = 'Collection health unavailable';
$LNG['telemetry_label_storage_full'] = 'Storage: collection suspended';
$LNG['telemetry_label_analysis_failed'] = 'Analysis failed';
$LNG['telemetry_label_pushing'] = 'One-sided exchange';
$LNG['telemetry_ui_settings_title'] = 'Activity settings';
$LNG['telemetry_ui_timezone'] = 'Timezone';
$LNG['telemetry_ui_apply'] = 'Apply';
$LNG['telemetry_ui_master_disabled'] = 'Collection disabled in the server configuration.';
$LNG['telemetry_ui_review'] = 'To review';
$LNG['telemetry_ui_follow_up'] = 'Follow up';
$LNG['telemetry_ui_dismissed_plural'] = 'Dismissed';
$LNG['telemetry_ui_settings'] = 'Settings';
$LNG['telemetry_ui_health'] = 'Collection health';
$LNG['telemetry_ui_case'] = 'Case #';
$LNG['telemetry_ui_strength'] = 'Strength';
$LNG['telemetry_ui_status'] = 'Status';
$LNG['telemetry_ui_created'] = 'Created on ';
$LNG['telemetry_ui_last_observation_on'] = ', last observed on ';
$LNG['telemetry_ui_view_activity'] = 'View activity';
$LNG['telemetry_ui_no_match'] = 'The thresholds are no longer met in the analysed period. The review decision is unchanged.';
$LNG['telemetry_ui_other_observations'] = 'Other observations: ';
$LNG['telemetry_ui_resources'] = 'Resources';
$LNG['telemetry_ui_metal'] = 'Metal';
$LNG['telemetry_ui_crystal'] = 'Crystal';
$LNG['telemetry_ui_deuterium'] = 'Deuterium';
$LNG['telemetry_ui_thresholds'] = 'Thresholds used';
$LNG['telemetry_ui_partial_batch'] = 'Analysis limit reached: this case covers a partial batch.';
...
$LNG['telemetry_ui_actor_target'] = 'Actor → target';
$LNG['telemetry_ui_action_fleet'] = 'Action / fleet';
$LNG['telemetry_ui_context'] = 'Context';
$LNG['telemetry_ui_decision'] = 'Decision ';
$LNG['telemetry_ui_dismissed'] = 'Dismissed';
$LNG['telemetry_ui_note'] = 'Note ';
$LNG['telemetry_ui_save_decision'] = 'Save decision';
$LNG['telemetry_ui_review_history'] = 'Review history';
$LNG['telemetry_ui_moderator'] = ' — moderator #';
$LNG['telemetry_ui_lookup'] = 'View account activity';
$LNG['telemetry_ui_account_id'] = 'Account (ID) ';
$LNG['telemetry_ui_compare_optional'] = 'Compare with (optional) ';
$LNG['telemetry_ui_period'] = 'Period ';
$LNG['telemetry_ui_days'] = ' days';
$LNG['telemetry_ui_show'] = 'Show';
$LNG['telemetry_ui_warnings_for'] = 'Warnings for ';
$LNG['telemetry_ui_warning'] = 'Warning';
$LNG['telemetry_ui_accounts_involved'] = 'Accounts involved';
$LNG['telemetry_ui_observations'] = 'Observations';
$LNG['telemetry_ui_no_warnings'] = 'No warnings for this account.';
$LNG['telemetry_ui_next_warnings'] = 'Next warnings';
$LNG['telemetry_ui_activity'] = 'Activity';
$LNG['telemetry_ui_average_time'] = 'Estimated active time / day';
$LNG['telemetry_ui_active_days'] = 'Active days';
$LNG['telemetry_ui_total_time'] = 'Total estimated active time';
$LNG['telemetry_ui_last_interaction'] = 'Last interaction';
$LNG['telemetry_ui_activity_daily'] = 'Daily activity';
$LNG['telemetry_ui_day'] = 'Day';
$LNG['telemetry_ui_active_time'] = 'Active time';
$LNG['telemetry_ui_estimated_activity'] = 'Estimated activity';
$LNG['telemetry_ui_windows'] = 'Activity windows';
$LNG['telemetry_ui_account'] = 'Account';
$LNG['telemetry_ui_times'] = 'Times';
$LNG['telemetry_ui_duration'] = 'Duration';
$LNG['telemetry_ui_actions_since'] = 'Actions since ';
$LNG['telemetry_ui_actions'] = 'Actions';
$LNG['telemetry_ui_sends'] = 'Fleet sends';
$LNG['telemetry_ui_recalls'] = 'Fleet recalls';
$LNG['telemetry_ui_ip_addresses'] = 'IP addresses';
$LNG['telemetry_ui_clients'] = 'Client profiles';
$LNG['telemetry_ui_galaxy_views'] = 'Galaxy views';
$LNG['telemetry_ui_network'] = 'IP addresses and clients used';
$LNG['telemetry_ui_client_reported'] = 'Browser, operating system and device type reported by the client.';
$LNG['telemetry_ui_requests'] = 'Requests';
$LNG['telemetry_ui_first_use'] = 'First use';
$LNG['telemetry_ui_last_use'] = 'Last use';
$LNG['telemetry_ui_no_observations'] = 'No observations in this period.';
$LNG['telemetry_ui_network_limit'] = 'The 50 most recently used combinations are shown.';
$LNG['telemetry_ui_recent_actions'] = 'Recent actions (up to 500 per account)';
$LNG['telemetry_ui_action'] = 'Action';
$LNG['telemetry_ui_warnings_by_account'] = 'Warnings by account';
$LNG['telemetry_ui_warnings'] = 'Warnings';
$LNG['telemetry_ui_last_observation'] = 'Last observation';
$LNG['telemetry_ui_no_accounts'] = 'No accounts in this view.';
$LNG['telemetry_ui_next_accounts'] = 'Next accounts';
$LNG['telemetry_ui_collection_module'] = 'Collection module: ';
$LNG['telemetry_ui_enabled_lower'] = 'enabled';
$LNG['telemetry_ui_disabled_lower'] = 'disabled';
$LNG['telemetry_ui_edit_modules'] = 'Change in Modules';
$LNG['telemetry_ui_save_settings'] = 'Save settings';
$LNG['telemetry_ui_reset_defaults'] = 'Restore defaults';
$LNG['telemetry_ui_settings_history'] = 'Recent settings changes';
$LNG['telemetry_access'] = 'Moderator access required.';
$LNG['telemetry_expired'] = 'Form expired. Reload the page.';
$LNG['telemetry_invalid_settings'] = 'Invalid settings.';
$LNG['telemetry_settings_saved'] = 'Settings saved.';
$LNG['telemetry_decision_saved'] = 'Decision saved.';
$LNG['telemetry_latest_evaluation'] = 'Latest evaluation';
$LNG['telemetry_opening'] = 'At opening';
$LNG['telemetry_deleted_account'] = 'Deleted account';
$LNG['telemetry_unavailable'] = 'Collection or analysis unavailable. Check the telemetry connection and tables.';
$LNG['telemetry_collection'] = 'Collection';
$LNG['telemetry_enabled'] = 'Enabled';
$LNG['telemetry_disabled'] = 'Disabled';
$LNG['telemetry_events'] = 'Events';
$LNG['telemetry_full'] = 'Suspended: storage full';
$LNG['telemetry_events_enabled'] = 'Enabled';
$LNG['telemetry_events_disabled'] = 'Disabled';
$LNG['telemetry_last_write'] = 'Last write';
$LNG['telemetry_none'] = 'None';
$LNG['telemetry_last_pass'] = 'Last analysis batch';
$LNG['telemetry_last_analysis'] = 'Last complete analysis';
$LNG['telemetry_none_female'] = 'None';
$LNG['telemetry_allocated'] = 'Allocated storage';
$LNG['telemetry_measure_pending'] = 'Measured at next cleanup';
$LNG['telemetry_event_retention'] = 'Detailed history retained';
$LNG['telemetry_activity_retention'] = 'Compact activity retained';
$LNG['telemetry_collection_failure'] = 'Collection failure';
$LNG['telemetry_group_activity'] = 'Long activity periods';
$LNG['telemetry_group_automation'] = 'Repeated actions';
$LNG['telemetry_group_pushing'] = 'Resource exchanges';
$LNG['telemetry_group_storage'] = 'Retention';
$LNG['telemetry_group_advanced'] = 'Advanced settings';
$LNG['telemetry_on'] = 'Enabled';
$LNG['telemetry_off'] = 'Disabled';
$LNG['telemetry_sent'] = 'Sent';
$LNG['telemetry_returned'] = 'Received in return';
$LNG['telemetry_overdue'] = 'Of which overdue';
$LNG['telemetry_pending_benefit'] = 'Pending benefit after allowance';
$LNG['telemetry_unpaid_benefit'] = 'Unpaid benefit after allowance';
$LNG['telemetry_threshold'] = 'Warning threshold';
$LNG['telemetry_equivalent'] = ' deut. equiv.';
$LNG['telemetry_allowance'] = 'Allowance';
$LNG['telemetry_rate'] = 'Selected M:C:D rate';
$LNG['telemetry_deadline'] = 'Deadline';
$LNG['telemetry_yes'] = 'Yes';
$LNG['telemetry_no'] = 'No';
$LNG['telemetry_invalid_decision'] = 'Invalid decision or note (4000 characters maximum).';
$LNG['telemetry_missing_case'] = 'Case not found.';
$LNG['telemetry_invalid_days'] = 'Required days exceed the analysis period.';
$LNG['telemetry_invalid_reserve'] = 'Free-space reserve must be below the size limit.';
$LNG['telemetry_invalid_rates'] = 'Minimum rates cannot exceed maximum rates.';
$LNG['telemetry_invalid_repayment'] = 'Exchange analysis must cover more than the repayment period.';
$LNG['telemetry_invalid_retention'] = 'Activity retention must cover the analysis period.';
$LNG['telemetry_unit_days'] = 'days';
$LNG['telemetry_unit_hours'] = 'hours';
$LNG['telemetry_unit_hours_day'] = 'hours/day';
$LNG['telemetry_unit_actions'] = 'actions';
$LNG['telemetry_unit_repetitions'] = 'repetitions';
$LNG['telemetry_unit_views'] = 'views';
$LNG['telemetry_unit_systems'] = 'systems';
$LNG['telemetry_unit_metal_deuterium'] = 'metal / deuterium';
$LNG['telemetry_unit_crystal_deuterium'] = 'crystal / deuterium';
$LNG['telemetry_unit_deuterium_equivalent'] = 'deuterium equivalent';
$LNG['telemetry_unit_mb'] = 'MB';
$LNG['telemetry_unit_rows'] = 'rows per table';
$LNG['telemetry_unit_accounts'] = 'accounts';
$LNG['telemetry_unit_events'] = 'events';
$LNG['telemetry_invalid_range'] = '%s: expected a value between %s and %s %s.';
$LNG['telemetry_invalid_event_retention'] = 'Keep detailed actions for at least %s days to cover analysis.';
$LNG['telemetry_duration_day'] = 'd';
$LNG['telemetry_explain_availability'] = 'Long periods of activity across several days.';
$LNG['telemetry_explain_timing'] = 'Regularly repeated intervals.';
$LNG['telemetry_explain_workflow'] = 'Repeated action sequence with regular timing.';
$LNG['telemetry_explain_polling'] = 'Repeated galaxy views.';
$LNG['telemetry_explain_traversal'] = 'Traversal of neighbouring systems.';
$LNG['telemetry_explain_pushing'] = 'Strongly one-sided deliveries after the repayment deadline.';