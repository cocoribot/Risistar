...
$LNG['telemetry_setting_moon_context_hours_help'] = 'A combat close in time may be a moon attempt.';
$LNG['telemetry_setting_push_points_fraction'] = 'Threshold based on the receiver’s points';
$LNG['telemetry_setting_push_points_fraction_help'] = 'Part of the receiver’s points, counted as resources. The higher of the two thresholds is used.';
...
$LNG['telemetry_setting_timing_min'] = 'Requests per day before timing analysis';
$LNG['telemetry_setting_refresh_hours'] = 'Idle refresh hours in a row';
$LNG['telemetry_setting_refresh_hours_help'] = 'Hours with only reloads, planet switches or the alliance page: no other page, no action.';
$LNG['telemetry_setting_refresh_per_hour'] = 'Reloads or planet switches per idle hour';
$LNG['telemetry_setting_refresh_per_hour_help'] = 'Fewer in an hour do not count, e.g. a few queue reloads.';
$LNG['telemetry_setting_refresh_days'] = 'Days with idle refreshing';
$LNG['telemetry_setting_refresh_days_help'] = 'Days in the analysis period with at least one such run.';
...
$LNG['telemetry_setting_activity_days_help'] = 'Full days, in UTC.';
...
$LNG['telemetry_setting_network_hours'] = 'IP addresses and client profiles kept';
$LNG['telemetry_setting_network_hours_help'] = 'Hours after the last request from that address.';
$LNG['telemetry_label_availability'] = 'Activity span';
$LNG['telemetry_label_timing'] = 'Regular timing';
$LNG['telemetry_label_refreshing'] = 'Idle refreshing';
$LNG['telemetry_label_idle_hours'] = 'Hours with loads and no action';
$LNG['telemetry_label_loads'] = 'Loads without any action';
$LNG['telemetry_label_per_hour'] = 'Loads per hour';
$LNG['telemetry_label_shortest_wait'] = 'Shortest wait between loads';
$LNG['telemetry_label_average_wait'] = 'Average wait between loads';
$LNG['telemetry_label_longest_wait'] = 'Longest wait between loads';
$LNG['telemetry_label_switches'] = 'Planet switches';
$LNG['telemetry_label_alliance'] = 'Alliance page loads';
$LNG['telemetry_label_alliance_watch'] = 'Alliance page watching';
$LNG['telemetry_label_from'] = 'Start';
$LNG['telemetry_label_to'] = 'End';
...
$LNG['telemetry_client_other'] = 'Other';
$LNG['telemetry_client_desktop'] = 'desktop';
$LNG['telemetry_client_mobile'] = 'mobile';
$LNG['telemetry_client_tablet'] = 'tablet';
$LNG['telemetry_client_unknown'] = 'unknown type';
...
$LNG['telemetry_label_unpaid'] = 'Unpaid value (deuterium equivalent)';
$LNG['telemetry_label_lifetime'] = 'All-time exchange';
$LNG['telemetry_label_deliveries'] = 'Deliveries';
$LNG['telemetry_label_returned_deliveries'] = 'Deliveries in return';
$LNG['telemetry_label_since'] = 'Since';
$LNG['telemetry_label_ships'] = 'Ships';
$LNG['telemetry_label_ship_value'] = 'Ship value';
...
$LNG['telemetry_label_fleet'] = 'Fleet';
$LNG['telemetry_label_write_failed'] = 'Write failed';
$LNG['telemetry_label_buffer_failed'] = 'Buffer failed';
$LNG['telemetry_label_storage_events'] = 'Storage full: detailed actions paused';
$LNG['telemetry_label_health_unavailable'] = 'Collection status file unavailable';
$LNG['telemetry_label_storage_full'] = 'Storage full: collection paused';
...
$LNG['telemetry_ui_page_loads'] = 'Page loads';
$LNG['telemetry_ui_queue_reloads'] = 'Automatic queue reloads';
$LNG['telemetry_ui_planet_switches'] = 'Planet switches';
$LNG['telemetry_ui_alliance_views'] = 'Alliance page views';
...
$LNG['telemetry_ui_recent_actions'] = 'Recent deliveries and combats (up to 500 per account)';
...
$LNG['telemetry_reopened'] = 'Opened again: new evidence after the case no longer matched';
...
$LNG['telemetry_event_retention'] = 'Deliveries and combats kept';
$LNG['telemetry_network_retention'] = 'IP addresses and browsers kept';
$LNG['telemetry_activity_retention'] = 'Activity time kept';
...
$LNG['telemetry_rate'] = 'Allowed M:C:D rates';
...
$LNG['telemetry_unit_loads_hour'] = 'loads/hour';
...
$LNG['telemetry_explain_timing'] = 'Most gaps between requests repeat the same few durations.';
$LNG['telemetry_explain_refreshing'] = 'Pages reloaded or planets switched for hours in a row with nothing else, on several days, even at random intervals.';
$LNG['telemetry_explain_alliance_watch'] = 'Alliance page reloaded for hours with nothing else, on several days: it shows fleets against every member.';
$LNG['telemetry_explain_pushing'] = 'Deliveries mostly in one direction, not repaid in time.';